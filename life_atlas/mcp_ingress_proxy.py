...
def mcp_status():
    ...
    try:
        ...
        health = json.loads(body.decode("utf-8")).get("status", "unknown")
        # The upstream MCP reports 503/unhealthy before OAuth because its
        # health check includes authentication and a live Google API call.
