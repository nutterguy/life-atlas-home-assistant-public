...
class AgentAPITests(unittest.TestCase):
    ...
    def test_whatsapp_search_and_promotion_are_available_to_agents(self):
        ...
        original_context = app.whatsapp_context
        ...
        app.whatsapp_context = lambda source_id, before, after: {
            "focus_source_id": source_id, "conversation_id": "chat-1", "items": []
        }
        ...
        try:
            ...
            status, context = self.request("/v1/whatsapp/context?source_id=wa-1")
            self.assertEqual(status, 200)
            self.assertEqual(context["focus_source_id"], "wa-1")
            ...
            app.whatsapp_context = original_context
